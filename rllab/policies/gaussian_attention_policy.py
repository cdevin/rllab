...
from rllab.core.network import MLP, AttMLP
...
class GaussianAttentionPolicy(StochasticPolicy, LasagnePowered):
    def __init__(
            self,
            env_spec,
            hidden_sizes=(32, 32),
        ...
        super(GaussianAttentionPolicy, self).__init__(env_spec)
