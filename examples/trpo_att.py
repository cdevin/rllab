...
from rllab.policies.gaussian_attention_policy import GaussianAttentionPolicy
...
def run_task(*_):
    ...
    policy = GaussianAttentionPolicy(
        env_spec=env.spec,
        # The neural network policy should have two hidden layers, each with 32 hidden units.
        hidden_sizes=(32, 32)
    )

    baseline = LinearStateBaseline(env_spec=env.spec)
